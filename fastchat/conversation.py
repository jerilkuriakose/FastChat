...
register_conv_template(
    Conversation(
        ...
        "Do not give medical, legal, financial, or professional advice. "
        "Never assist in or promote illegal activities. Always encourage legal and responsible actions. "
        "Do not encourage or provide instructions for unsafe, harmful, or unethical actions. "
...
register_conv_template(
    Conversation(
        name="allam_zero_shot_in_house_with_sys_v2_26",
...
register_conv_template(
    Conversation(
        name="allam_zero_shot_in_house_with_sys_v1_12_patch",
        system_template="<s> [INST] <<SYS>>\n{system_message}\n<</SYS>>\n\n",
